...
> **★ユーザー決定 (2026-06-13)**: D-5=**①即時反映** (S4d eval 修正を flag-OFF production にも反映、bolt-on は S4 で deprecate)。D-1=**控えめに material 減価を S4d に入れる** (小係数、S4e 校正)。D-2=**損失上限つき tie-break を S4d-5 で実装** (係数は S4e 校正)。D-3=follow 推奨で進める。D-4=kernel 配下推奨で進める。
