...
**template ベース** (PR1b のパターン 1-5: 駒種境界 / 王手中合駒 / ピン駒 / 持ち駒打ち / 王手放置) では、template 自体を active 局面前提で手書きするため status filter のみで十分 (random walk は不要)。
...
- **random walk** (パターン 6-7): 初期局面から合法手を Mulberry32 seed で 1 手選びながら walk
