...
| 2 | `pawn_return` | 歩戻し | normal | common | **1** (旧3) | **仕様確定** — 2026-05-02、コスト 3→1 に変更 (他項目は現状維持) |
| 3 | `no_promote` | 成り無効化 | trap | rare | 4 | **仕様確定** — 2026-05-02、効果を「成り宣言を1回無効化」→「成り不可状態を永続付与(取られたら消失=案A)」に変更。実装込みで本Issueで完結 |
